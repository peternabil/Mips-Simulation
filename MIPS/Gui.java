...
//                functioncode.setText(""+a.instructionMem.instructions[0].functioncode);
//                opcode.setText(""+a.instructionMem.instructions[0].opcode);
//                rs.setText(a.instructionMem.instructions[0].rs+"");
//                rt.setText(""+a.instructionMem.instructions[0].rt);
//                rd.setText(""+a.instructionMem.instructions[0].rd);
//                c=new Control(a.instructionMem.instructions[0].opcode);
